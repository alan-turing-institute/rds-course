...
This study looked at the medical records of tens of thousands first-time incarcerated people and finds that some groups (white people) are more likely 
...
seems neutral and free of bias however does not succeeds to communicate the research findings, by itself it provides an incomplete message. The
